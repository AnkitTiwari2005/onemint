        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: 10, overflow: 'hidden' }}>
            <button type="button" onClick={() => setPubOpen(!pubOpen)} style={{ width: '100%', padding: '13px 18px', background: 'transparent', border: 'none', borderBottom: pubOpen ? '1px solid var(--color-border)' : 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer', outline: 'none' }}>
              ...
              <span style={{ fontFamily: 'var(--font-ui)', fontSize: 10, fontWeight: 700, color: 'var(--color-ink-tertiary)', letterSpacing: '0.07em' }}>{pubOpen ? '▲' : '▼'}</span>
            </button>
            ...
            {pubOpen && (
              <div style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <div>
                  ...
                  <p style={{ fontFamily: 'var(--font-ui)', fontSize: 10, color: 'var(--color-ink-tertiary)', margin: '4px 0 0', lineHeight: 1.4 }}>Shows a disclosure banner above the article.</p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe what was corrected and when… (leave blank if none)"
                    rows={3}
                  ...
                  />
                  <p style={{ fontFamily: 'var(--font-ui)', fontSize: 10, color: 'var(--color-ink-tertiary)', margin: '4px 0 0', lineHeight: 1.4 }}>Shown as an amber correction banner at the end of the article.</p>
                </div>
