...
// 404 pages should never be indexed — handled in page metadata below.
// This client wrapper tracks the broken URL in GA4 so you can audit 404s.
export default function NotFoundClient() {
  const pathname = usePathname();

  useEffect(() => {
    // Fire GA4 event so broken URLs show up in analytics
